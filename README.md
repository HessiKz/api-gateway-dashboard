...
> Unified gateway metrics: routes, latency p50/p95/p99, error rate, top consumers, key rotation.

**Category:** Backend / DevOps  
**Built with:** Express, JWT, Redis, React, Prometheus  
...
👉 https://HessiKz.github.io/api-gateway-dashboard/

## Features

- Interactive, client-side visualisation of the Backend / DevOps concept
...
git clone https://github.com/HessiKz/api-gateway-dashboard.git
